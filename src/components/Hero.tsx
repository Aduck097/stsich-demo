    ...
    <section className="max-w-7xl mx-auto px-8 py-20 md:py-32 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
      ...
      >
        <span className="inline-block px-4 py-1.5 rounded-full bg-surface-container-high text-primary text-[10px] font-bold uppercase tracking-[0.2em] mb-6">
          Digital Curator & Product Designer
        </span>
        <h1 className="text-5xl md:text-7xl font-bold tracking-tighter text-on-surface leading-[1.05] mb-8">
          ...
          <span className="text-on-surface-variant">editorial intent.</span>
        </h1>
        <p className="text-lg md:text-xl text-on-surface-variant leading-relaxed max-w-lg mb-12">
          I believe in the power of white space, functional beauty, and the
          quiet authority of minimalist design. Creating tools for the
        ...
        <div className="flex flex-wrap items-center gap-6">
          ...
          <button className="text-on-surface font-medium text-base px-6 py-4 flex items-center gap-2 group transition-all">
            My Story
